...
<div style="margin:20; display:flex; flex-direction:column; height:700px; max-width:700px">
    <iframe border="0" src="https://crosswordlabs.com/embed/cryptography-crossword-puzzle?clue_height=70" style="flex:1; width:100%; padding:5px 0px 0 5px; border:3px solid black; "></iframe>
